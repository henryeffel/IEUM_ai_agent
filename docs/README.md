...
최신 공개 배포 결과는 [2026-09-22 임베딩 모델 교체 및 운영 검증](./embedding-model-eol.md#2026-09-22-운영-적용-결과)에서 확인할 수 있다. 초기 공개 배포 과정은 [공개 배포 및 검증 기록](./deployment-verification.md)에 남겨 두었다.
